...
- (void) viewDidLoad {
    ...
    [button addTarget:self action:@selector(share) forControlEvents:UIControlEventAllEvents];
    [button setTitle:@"Share" forState:UIControlStateNormal];
    button.frame = CGRectMake(self.view.bounds.size.width - 60.0, 20.0, 40.0, 40.0);
...
- (void) share {
    ...
    [itemToShare addObject:self.imageView.image];
